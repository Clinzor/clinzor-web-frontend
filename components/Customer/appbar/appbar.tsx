...
const Badge = ({ children, color = 'blue' }: { children: React.ReactNode; color?: 'blue' | 'red' | 'green' | 'yellow' | 'purple' }) => {
  const colorClasses = {
...
export default function CustomerSidebar() {
  ...
  const menuItems = [
    { icon: <Home size={20} strokeWidth={1.5} />, label: 'Dashboard', href: '/dashboard' },
    { icon: <User size={20} strokeWidth={1.5} />, label: 'My Profile', href: '/profile' },
  ];
  ...
  const nestedMenuItems = [
    {
      ...
      children: [
        { label: 'Upcoming', href: '/appointments/upcoming', badge: '2', badgeColor: 'green' as const },
        { label: 'Past Appointments', href: '/appointments/past' },
        { label: 'Cancelled', href: '/appointments/cancelled', badge: '1', badgeColor: 'red' as const },
        { label: 'Reschedule', href: '/appointments/reschedule' }
      ]
    },
    {
      ...
      children: [
        { label: 'Search Doctors', href: '/doctors/search' },
        { label: 'Specialists', href: '/doctors/specialists' },
        { label: 'Nearby Doctors', href: '/doctors/nearby' },
        { label: 'Favorite Doctors', href: '/doctors/favorites', badge: '5', badgeColor: 'purple' as const }
      ]
    },
    {
      ...
      badgeColor: 'blue' as const,
      children: [
        { label: 'Find Clinics', href: '/clinics/search' },
        { label: 'Hospitals', href: '/clinics/hospitals' },
        { label: 'Diagnostic Centers', href: '/clinics/diagnostic' },
        { label: 'Pharmacies', href: '/clinics/pharmacies' }
      ]
    },
    {
      ...
      children: [
        { label: 'My Reviews', href: '/reviews/my-reviews' },
        { label: 'Write Review', href: '/reviews/write' },
    ...
    },
    {
      ...
      badgeColor: 'green' as const,
      children: [
        { label: 'Medical History', href: '/health/history' },
        { label: 'Prescriptions', href: '/health/prescriptions', badge: '3', badgeColor: 'blue' as const },
        { label: 'Lab Reports', href: '/health/lab-reports' },
        { label: 'Vaccination Records', href: '/health/vaccinations' }
      ]
    },
    {
      ...
      children: [
        ...
        { label: 'Pending Bills', href: '/billing/pending', badge: '2', badgeColor: 'red' as const },
    ...
    },
    {
      ...
      badgeColor: 'blue' as const,
      children: [
        { label: 'Doctor Messages', href: '/messages/doctors', badge: '3', badgeColor: 'blue' as const },
        { label: 'Appointment Reminders', href: '/messages/reminders' },
        { label: 'Health Tips', href: '/messages/health-tips', badge: '2', badgeColor: 'green' as const }
      ]
    }
  ];

  const bottomMenuItems = [
    { icon: <BookOpen size={20} strokeWidth={1.5} />, label: 'Health Blog', href: '/blog', badge: '8', badgeColor: 'purple' as const },
    { icon: <Heart size={20} strokeWidth={1.5} />, label: 'Wellness Tips', href: '/wellness' },
    { icon: <Phone size={20} strokeWidth={1.5} />, label: 'Emergency Contact', href: '/emergency' },
    { icon: <HelpCircle size={20} strokeWidth={1.5} />, label: 'Help & Support', href: '/help' },
  ];
        ...
        {collapsed ? (
          ...
          <div className="flex items-center">
            ...
            <div className="ml-3 min-w-0">
              <h1 className="font-semibold text-gray-800 truncate">HealthCare</h1>
              <p className="text-xs text-purple-600 truncate">Your Health Partner</p>
            </div>
          </div>
        )}
      </div>
      ...
      {!collapsed && (
        <div className="px-4 sm:px-5 py-4">
          <div className="p-4 bg-gradient-to-r from-green-50 to-blue-50 rounded-xl border border-green-100">
            ...
            <p className="text-xs text-gray-600 mb-3">Dr. Smith - Tomorrow 10:00 AM</p>
            <a 
              href="/appointments/upcoming"
              className="block w-full py-2 text-center text-xs font-medium text-green-600 bg-white rounded-lg border border-green-100 hover:border-green-200 hover:shadow-sm transition-all duration-200 touch-manipulation active:scale-95"
            >
              View Details
            </a>
          </div>

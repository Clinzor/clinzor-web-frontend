...
import PendingApprovalPage from "@/components/admin/clincs/PendingClinics";
import PaymentRecordsDashboard from "@/components/admin/bookingmanagement/paymentrecords";
